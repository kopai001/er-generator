...
import { PositionTxnTypeEnum } from 'src/enums/position-txn-type.enum';
...
export class PositionTxnBase {
  ...
  @Column({ nullable: true, type: 'decimal' })
  compensationAmount: number; // ค่าตอบแทน

  @Column({ nullable: true, type: 'enum', enum: PositionTxnTypeEnum })
  type: PositionTxnTypeEnum;
...
export class PositionTxn extends mixin(PositionTxnBase, StampableEntity) {}
